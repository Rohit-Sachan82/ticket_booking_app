...
public class adminpanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rfidScannerButton = findViewById(R.id.rfid_scanner);
        rfidScannerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Intent to open the RFID/QR scanner
                Intent intent = new Intent(adminpanel.this, ScannerActivity.class);
                startActivity(intent);
            }
        });
